  ...
  return (
    ...
    >
      <input
        type='text'
        placeholder='Search...'
        className='will-change w-full h-9 rounded-md py-1 pl-2 pr-8 font-primary tracking-wide text-offblack placeholder-grey-400 placeholder:italic shadow-[0_0_2px_#0F0F0F] shadow-offblack transition-all ease-out hover:scale-105 hover:shadow-[0_0_4px_#0F0F0F] focus:ring-0 focus:ring-pearl sm:w-[200px] md:w-64'
        value={searchQuery}
