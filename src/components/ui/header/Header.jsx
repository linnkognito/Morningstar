  ...
  return (
    <div className="flex w-full justify-center border-b border-zest/20">
      <header className="flex w-full max-w-[1324px] items-center justify-between gap-2 font-bebas leading-normal text-pearl">
        ...
        <h1
          className="w-full cursor-pointer text-[2.3rem] transition-all duration-300 hover:animate-gradient hover:bg-gradient-to-r hover:from-zest hover:to-aura hover:bg-[length:200%] hover:bg-clip-text hover:text-transparent md:text-5xl xl:text-center"
          onClick={() => navigate("/")}
        >
          Morning Star
        </h1>
